...
@testset begin
    @testset "LetterSet" begin 
        ...
        @test find_last_letter(LS("abc")) == 3
        @test find_last_letter(LS("az")) == 26
        @test find_last_missing(LS("abc")) == 26
        @test find_last_missing(LS("az")) == 25
        @test ==(find_last_missing(fill_last_missing(LS("az"))), find_last_missing(LS("ayz")))
        @test ==(find_last_missing(fill_last_missing(LS("xz"))), find_last_missing(LS("xyz")))
    end
